...
(def gallery-item-link {:css "a.js-project-cover-title-link"})
(def gallery-item-content {:css "div#primary-project-content"})
(def gallery-item-appreciate {:css "div.rf-appreciation"})
